...
int main() {
	...
	const DWORD targetFrameTime = 16; 
	DWORD frameStart;
	...
	while (true) {
		...
		const int shipMinX = 20 + 15;                                  
		const int shipMaxX = full_screen_width - 20 - 90;              
		const int shipMinY = 20;                                      
		const int shipMaxY = full_screen_height - 20 - 31;             
